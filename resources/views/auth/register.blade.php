    ...
    <div class=" row justify-content-center">
        <div class="btn-group mt-3 mb-3">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="#">Personne physique</a>
                <a class="dropdown-item" href="#">Personne morale / Entreprise</a>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8 mb-3">
            <div class="card" style="display: none;">
                ...
                <div class="card-body">
                    <form id="form_personnePhysique" method="POST" action="{{ route('register') }}">
                        @csrf
